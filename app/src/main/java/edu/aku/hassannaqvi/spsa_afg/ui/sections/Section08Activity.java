...
public class Section08Activity extends AppCompatActivity {
    ...
    private void SaveDraft() {
        ...
        form.setS8q1(bi.s8q101.isChecked() ? "1"
                ...
                : "-1");
        form.setS8q1a(bi.s8q1a.getText().toString().trim().isEmpty() ? "-1" : bi.s8q1a.getText().toString());

        form.setS8q2(bi.s8q201.isChecked() ? "1"
                : bi.s8q202.isChecked() ? "2"
                : "-1");
        form.setS8q2a(bi.s8q2a.getText().toString().trim().isEmpty() ? "-1" : bi.s8q2a.getText().toString());
        ...
        form.setS8q2b96x(bi.s8q2b96x.getText().toString().isEmpty() ? "-1" : bi.s8q2b96x.getText().toString());
        ...
        form.setS8q2c96x(bi.s8q2c96x.getText().toString().isEmpty() ? "-1" : bi.s8q2c96x.getText().toString());
        ...
        form.setS8q7a(bi.s8q7a01.isChecked() ? "1"
                : bi.s8q7a02.isChecked() ? "2"
                : bi.s8q7a98.isChecked() ? "98"
                : "-1");
        form.setS8q7a01x(bi.s8q7a01x.getText().toString().trim().isEmpty() ? "-1" : bi.s8q7a01x.getText().toString());
        form.setS8q7a02x(bi.s8q7a02x.getText().toString().trim().isEmpty() ? "-1" : bi.s8q7a02x.getText().toString());
        ...
        form.setS8q896x(bi.s8q896x.getText().toString().trim().isEmpty() ? "-1" : bi.s8q896x.getText().toString());
        ...
        form.setS8q9(bi.s8q901.isChecked() ? "1"
                ...
                : "-1");
        form.setS8q996x(bi.s8q996x.getText().toString().trim().isEmpty() ? "-1" : bi.s8q996x.getText().toString());

        form.setS8q10(bi.s8q1001.isChecked() ? "1"
        ...
        form.setS8q12(bi.s8q1201.isChecked() ? "1"
                ...
                : "-1");
        form.setS8q1296x(bi.s8q1296x.getText().toString().trim().isEmpty() ? "-1" : bi.s8q1296x.getText().toString());
        ...
        form.setS8q13(bi.s8q1301.isChecked() ? "1"
                ...
                : "-1");
        form.setS8q1396x(bi.s8q1396x.getText().toString().trim().isEmpty() ? "-1" : bi.s8q1396x.getText().toString());
