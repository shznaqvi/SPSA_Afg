...
public class Section02Activity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        json.put("s2q1", bi.s2q101.isChecked() ? "1"
        ...
        json.put("s2q196x", bi.s2q196x.getText().toString());
        json.put("s2q2", bi.s2q201.isChecked() ? "1"
                : bi.s2q202.isChecked() ? "2"
                : bi.s2q296.isChecked() ? "96"
                :  "-1");

        json.put("s2q296x", bi.s2q296x.getText().toString());
        json.put("s2q3", bi.s2q301.isChecked() ? "1"
        ...
        json.put("s2q396x", bi.s2q396x.getText().toString());
        json.put("s2q4", bi.s2q401.isChecked() ? "1"
                : bi.s2q402.isChecked() ? "2"
                :  "-1");

        json.put("s2q5", bi.s2q501.isChecked() ? "1"
        ...
        json.put("s2q596x", bi.s2q596x.getText().toString());
        json.put("s2q6", bi.s2q601.isChecked() ? "1"
        ...
        json.put("s2q696x", bi.s2q696x.getText().toString());
        json.put("s2q7", bi.s2q701.isChecked() ? "1"
                : bi.s2q702.isChecked() ? "2"
                :  "-1");

        json.put("s2q8", bi.s2q801.isChecked() ? ""
                : bi.s2q811.isChecked() ? "11"
                : bi.s2q898.isChecked() ? "98"
                :  "-1");

        json.put("s2q801x", bi.s2q801x.getText().toString());
        json.put("s2q9a", bi.s2q9a01.isChecked() ? "1"
                : bi.s2q9a02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9b", bi.s2q9b01.isChecked() ? "1"
                : bi.s2q9b02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9c", bi.s2q9c01.isChecked() ? "1"
                : bi.s2q9c02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9d", bi.s2q9d01.isChecked() ? "1"
                : bi.s2q9d02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9e", bi.s2q9e01.isChecked() ? "1"
                : bi.s2q9e02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9f", bi.s2q9f01.isChecked() ? "1"
                : bi.s2q9f02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9g", bi.s2q9g01.isChecked() ? "1"
                : bi.s2q9g02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9h", bi.s2q9h01.isChecked() ? "1"
                : bi.s2q9h02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9i", bi.s2q9i01.isChecked() ? "1"
                : bi.s2q9i02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9j", bi.s2q9j01.isChecked() ? "1"
                : bi.s2q9j02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9k", bi.s2q9k01.isChecked() ? "1"
                : bi.s2q9k02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9l", bi.s2q9l01.isChecked() ? "1"
                : bi.s2q9l02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9m", bi.s2q9m01.isChecked() ? "1"
                : bi.s2q9m02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9n", bi.s2q9n01.isChecked() ? "1"
                : bi.s2q9n02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9o", bi.s2q9o01.isChecked() ? "1"
                : bi.s2q9o02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9p", bi.s2q9p01.isChecked() ? "1"
                : bi.s2q9p02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9q", bi.s2q9q01.isChecked() ? "1"
                : bi.s2q9q02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9r", bi.s2q9r01.isChecked() ? "1"
                : bi.s2q9r02.isChecked() ? "2"
                :  "-1");

        json.put("s2q9s", bi.s2q9s01.isChecked() ? "1"
                : bi.s2q9s02.isChecked() ? "2"
                :  "-1");

        json.put("s2q10a", bi.s2q10a01.isChecked() ? "1"
                : bi.s2q10a02.isChecked() ? "2"
                :  "-1");

        json.put("s2q10b", bi.s2q10b01.isChecked() ? "1"
                : bi.s2q10b02.isChecked() ? "2"
                :  "-1");

        json.put("s2q10c", bi.s2q10c01.isChecked() ? "1"
                : bi.s2q10c02.isChecked() ? "2"
                :  "-1");

        json.put("s2q10d", bi.s2q10d01.isChecked() ? "1"
                : bi.s2q10d02.isChecked() ? "2"
                :  "-1");

        json.put("s2q10e", bi.s2q10e01.isChecked() ? "1"
                : bi.s2q10e02.isChecked() ? "2"
                :  "-1");

        json.put("s2q10f", bi.s2q10f01.isChecked() ? "1"
                : bi.s2q10f02.isChecked() ? "2"
                :  "-1");

        json.put("s2q10g", bi.s2q10g01.isChecked() ? "1"
                : bi.s2q10g02.isChecked() ? "2"
                :  "-1");

        json.put("s2q10h", bi.s2q10h01.isChecked() ? "1"
                : bi.s2q10h02.isChecked() ? "2"
                :  "-1");

        json.put("s2q10i", bi.s2q10i01.isChecked() ? "1"
                : bi.s2q10i02.isChecked() ? "2"
                :  "-1");

        json.put("s2q11", bi.s2q1101.isChecked() ? "1"
        ...
        json.put("s2q1196x", bi.s2q1196x.getText().toString());
        json.put("s2q12", bi.s2q1211.isChecked() ? "11"
        ...
        json.put("s2q1296x", bi.s2q1296x.getText().toString());
        json.put("s2q13", bi.s2q1311.isChecked() ? "11"
        ...
        json.put("s2q1396x", bi.s2q1396x.getText().toString());
        json.put("s2q14", bi.s2q1411.isChecked() ? "11"
        ...
        json.put("s2q1496x", bi.s2q1496x.getText().toString());
        json.put("s2q15", bi.s2q15.getText().toString());

        json.put("s2q16", bi.s2q1601.isChecked() ? "1"
                : bi.s2q1602.isChecked() ? "2"
                :  "-1");

        json.put("s2q17", bi.s2q1701.isChecked() ? ""
                : bi.s2q1702.isChecked() ? ""
                : bi.s2q1703.isChecked() ? ""
                : bi.s2q1798.isChecked() ? "98"
                :  "-1");

        json.put("s2q1701x", bi.s2q1701x.getText().toString());
        json.put("s2q1702x", bi.s2q1702x.getText().toString());
        json.put("s2q1703x", bi.s2q1703x.getText().toString());
        json.put("s2q18", bi.s2q1801.isChecked() ? "1"
                : bi.s2q1802.isChecked() ? "2"
                :  "-1");

        json.put("s2q1901", bi.s2q1901.getText().toString());

        json.put("s2q1902", bi.s2q1902.getText().toString());

        json.put("s2q1903", bi.s2q1903.getText().toString());

        json.put("s2q1904", bi.s2q1904.getText().toString());

        json.put("s2q1905", bi.s2q1905.getText().toString());

        json.put("s2q1906", bi.s2q1906.getText().toString());

        json.put("s2q1907", bi.s2q1907.getText().toString());

        json.put("s2q20", bi.s2q201.isChecked() ? "1"
                : bi.s2q202.isChecked() ? "2"
                : bi.s2q2098.isChecked() ? "98"
                :  "-1");
