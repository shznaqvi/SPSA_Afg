...
public class Section12Activity extends AppCompatActivity {
    ...
    private void SaveDraft() {
        ...
        form.setS12q696x(bi.s12q696x.getText().toString());
