    ...
    private void setupSkips() {
        ...
        bi.s12q1.setOnCheckedChangeListener(((radioGroup, i) -> {
            if (i != bi.s12q101.getId()) {
                Clear.clearAllFields(bi.llGrpS12q1a);
            }
        }));
