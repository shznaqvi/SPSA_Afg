...
public class Section1102Activity extends AppCompatActivity {
    ...
    private void setupSkips() {
        ...
        bi.s11q13.setOnCheckedChangeListener(((radioGroup, i) -> {
            if (i == bi.s11q1302.getId() || i == bi.s11q1398.getId()) {
        ...
        radioGroup(bi.s11q12a);
        radioGroup(bi.s11q12b);
        radioGroup(bi.s11q12c);
        radioGroup(bi.s11q12d);
        radioGroup(bi.s11q12e);
        radioGroup(bi.s11q12f);
        radioGroup(bi.s11q12g);
        radioGroup(bi.s11q12h);
        radioGroup(bi.s11q12i);
        radioGroup(bi.s11q12j);
        radioGroup(bi.s11q12k);
        radioGroup(bi.s11q12l);
        radioGroup(bi.s11q12m);
        radioGroup(bi.s11q12n);
        radioGroup(bi.s11q12o);
        radioGroup(bi.s11q12p);
        radioGroup(bi.s11q12q);
    ...
    public void radioGroup(RadioGroup grp) {
        ...
        grp.setOnCheckedChangeListener(((radioGroup, i) -> {
            if (bi.s11q12a02.isChecked() && bi.s11q12b02.isChecked() && bi.s11q12c02.isChecked()
                    && bi.s11q12d02.isChecked() && bi.s11q12e02.isChecked() && bi.s11q12f02.isChecked()
                    && bi.s11q12g02.isChecked() && bi.s11q12h02.isChecked() && bi.s11q12i02.isChecked()
                    && bi.s11q12j02.isChecked() && bi.s11q12k02.isChecked() && bi.s11q12l02.isChecked() && bi.s11q12m02.isChecked()
                    && bi.s11q12n02.isChecked() && bi.s11q12o02.isChecked() && bi.s11q12p02.isChecked() && bi.s11q12q02.isChecked()) {
                Clear.clearAllFields(bi.fldGrpCVs11q13);
                bi.fldGrpCVs11q13.setVisibility(View.VISIBLE);
            } else {
                Clear.clearAllFields(bi.fldGrpCVs11q13);
                bi.fldGrpCVs11q13.setVisibility(View.GONE);
            }
        }));
    }
