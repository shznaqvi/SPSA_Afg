...
/*    public String getREGION_DSS() {
    ...
    public Users Sync(JSONObject jsonObject) throws JSONException {
        ...
        this.full_name = jsonObject.getString(UsersContract.UsersTable.COLUMN_FULL_NAME);
//        this.REGION_DSS = jsonObject.getString(singleUser.REGION_DSS);
    ...
    public Users Hydrate(Cursor cursor) {
        this.id = cursor.getLong(cursor.getColumnIndex(UsersContract.UsersTable._ID));
        ...
        this.full_name = cursor.getString(cursor.getColumnIndex(UsersContract.UsersTable.COLUMN_FULL_NAME));
//        this.REGION_DSS = cursor.getString(cursor.getColumnIndex(singleUser.REGION_DSS));
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(UsersContract.UsersTable._ID, this.id == null ? JSONObject.NULL : this.id);
        ...
        json.put(UsersContract.UsersTable.COLUMN_FULL_NAME, this.full_name == null ? JSONObject.NULL : this.full_name);
